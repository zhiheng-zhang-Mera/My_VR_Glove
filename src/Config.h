...
//serial over USB
#if defined(ESP32)
  // [Configuration] High Baud Rate for ESP32
  // 921600 provides significantly lower latency than standard 115200.
  // [配置] ESP32 高波特率
  // 921600 比标准的 115200 延迟显著更低。
  #define SERIAL_BAUD_RATE 921600
#else
  // Standard Baud Rate for AVR/Arduino
  // 适用于 AVR/Arduino 的标准波特率
...
#define SERVO_SCALING true //dynamic scaling of servo motors
  ...
  #define PIN_PINKY     36 //VP
  #define PIN_RING      39 //VN
